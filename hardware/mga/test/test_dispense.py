...
from hardware.mga.configuration import StandardGeometry, ReagentToLineMapping
import numpy as np
import sys
...
class TestCreateRoutine(unittest.TestCase):
    ...
    def test_create_routine_single_line_forward(self):
        wells: list[Well] = [
            Well(row=row, column=column)
    ...
    def test_create_routine_single_line_backward(self):
        wells: list[Well] = [
            Well(row=row, column=column)
            for row in range(0, 8, 2)
            for column in range(0, 2)
    ...
    def test_create_routine_multi_line_same_manifold_forward(self):
        wells: list[Well] = [
            Well(row=row, column=column)
            for row in range(0, 8, 2)
            for column in range(0, 2)
    ...
    def test_create_routine_multi_line_same_manifold_backward(self):
        wells: list[Well] = [
            Well(row=row, column=column)
            for row in range(0, 8, 2)
            for column in range(0, 2)
    ...
    def test_create_routine_multi_line_different_manifold_forward(self):
        wells: list[Well] = [
            Well(row=row, column=column)
            for row in range(0, 16, 2)
            for column in range(0, 2)
    ...
    def test_create_routine_multi_line_single_manifold_missing_column(self):
        wells: list[Well] = [
            Well(row=row, column=column)
            for row in range(0, 16, 2)
...
def create_geogram(routine: Routine) -> str:
    ...
    # output = f"Range [{start:.4f}, {end:.4f}) Step: {step:.4f}\n"
    output = ""
